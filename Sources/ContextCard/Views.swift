    ...
    var body: some View {
        Form {
            ...
            Section("Translation") {
                ...
                Text("The key is stored in macOS Keychain and is also used for the AI-generated voice.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }

            Section("Audio") {
                Picker("Voice", selection: $model.speechVoice) {
                ...
                TextField("Speech model", text: $model.speechModel)
                Text("Audio is generated by OpenAI. Without an API key, the app falls back to the macOS system voice.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Button {
                    model.saveSettings()
